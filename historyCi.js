const history = JSON.parse(localStorage.getItem('compound interest')) || [];
for (let i = 0; i < history.length; i++) {
    display.innerHTML += `<div style="border: 3px solid black;width:auto;height:auto; margin-bottom:10px; text-align:left;justify-content:center;padding:10px;">
 ...
 <span style='background:green; color:white; padding:2px 6px; border-radius:4px;'>Rate:</span> ${history[i].compound}%<br><br>
...
const clear1 = () => {
    localStorage.removeItem('compound interest')
    location.reload()
}